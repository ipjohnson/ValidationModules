...
public static class SampleData
{
    ...
    public static Annotated.Customer ValidAnnotatedCustomer() =>
        new()
        {
            Name = "Ada Lovelace",
            Email = "ada@example.com",
    ...
    public static Annotated.Customer InvalidAnnotatedCustomer() =>
        new()
        {
            Name = null,
            Email = "not-an-email",
    ...
    public static Annotated.Order ValidAnnotatedOrder() =>
        new()
        {
            Reference = "ORD-0001",
    ...
    public static Annotated.Order InvalidAnnotatedOrder() =>
        new()
        {
            Reference = "nope",
            ...
            Lines =
            [
                ValidAnnotatedLine(1),
                ValidAnnotatedLine(2) with
                {
                    Quantity = 0,
                },
                ValidAnnotatedLine(3),
            ],
        };
    ...
    public static Annotated.Address ValidAnnotatedAddress() =>
        new()
        {
            Line1 = "1 Riverside Way",
            City = "Portland",
    ...
    public static OrderLine ValidLine(int seed) =>
        new() { Sku = Skus[seed % Skus.Length], Quantity = 1 + seed % 9 };

    public static Annotated.OrderLine ValidAnnotatedLine(int seed) =>
        new() { Sku = Skus[seed % Skus.Length], Quantity = 1 + seed % 9 };
