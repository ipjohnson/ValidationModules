...
public sealed class MutableNode
{
    ...
    [ValidateNested]
    public MutableNode? Child { get; set; }
}
...
{
    [ValidateNested]
    public Purchase? Order { get; init; }
}

public sealed record Purchase
{
    [ValidateNested]
    public IReadOnlyList<Line> Lines { get; init; } = new List<Line>();
}
...
public sealed record Payment
{
    ...
    [EnumDefined]
    public PaymentMethod? Fallback { get; init; }
}
