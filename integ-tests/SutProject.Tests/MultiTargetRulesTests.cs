...
public class MultiTargetRulesTests
{
    ...
    public void EachTarget_GetsItsOwnValidator()
    {
        ...
        Assert.True(
            new CreditNoteValidator()
                .Validate(new CreditNote { Number = "1234567890", Amount = 5m })
                .IsValid
        );
    }
    ...
    public void EachRegion_CarriesItsOwnRules()
    {
        ...
        Assert.Equal(
            [("number", ValidationCodes.StringLength), ("amount", "positive")],
    ...
    public void TheSharedConstant_GovernsBothTargets()
    {
        ...
        Assert.False(
            new CreditNoteValidator().IsValid(new CreditNote { Number = "123456789", Amount = 5m })
        );
    }
}
