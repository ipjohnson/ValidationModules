...
public class ValidationContextExtensionsTests
{
    ...
    public void AddRequired_ComposesTheStandardMessage()
    {
        Assert.Equal(
            "name is required.",
            Single(context => context.ReportRequired("name")).Message
        );
    }
    ...
    public void AddRequired_UsesTheSharedCode()
    {
        Assert.Equal(
            ...
            Single(context => context.ReportRequired("name")).Code
        );
    }
    ...
    public void AddStringLength_ComposesByWhichBoundsAreSet(int min, int max, string expected)
    {
        Assert.Equal(
            expected,
            Single(context => context.ReportStringLength("name", min, max)).Message
        );
    }
    ...
    public void AddItemCount_ComposesByWhichBoundsAreSet(int min, int max, string expected)
    {
        Assert.Equal(
            expected,
            Single(context => context.ReportItemCount("toys", min, max)).Message
        );
    }
    ...
    public void AddRange_FormatsBothBounds()
    {
        Assert.Equal(
            ...
            Single(context => context.ReportRange("age", 0, 30)).Message
        );
    }
    ...
    public void AddRangeAtLeast_NamesOnlyTheBoundThatWasDeclared()
    {
        Assert.Equal(
            ...
            Single(context => context.ReportRangeAtLeast("age", 1)).Message
        );
    }
    ...
    public void AddRangeAtMost_NamesOnlyTheBoundThatWasDeclared()
    {
        Assert.Equal(
            ...
            Single(context => context.ReportRangeAtMost("age", 99)).Message
        );
    }
    ...
    public void AddRangeAtLeastAndAtMost_ShareTheRangeCode()
    {
        ...
        Assert.Equal(
            ...
            Single(context => context.ReportRangeAtLeast("age", 1)).Code
        );
        Assert.Equal(
            ValidationCodes.Range,
            Single(context => context.ReportRangeAtMost("age", 99)).Code
        );
    }
    ...
    public void AddMultipleOf_NamesTheDivisor(double divisor, string expected)
    {
        Assert.Equal(
            expected,
            Single(context => context.ReportMultipleOf("quantity", (decimal)divisor)).Message
        );
    }
    ...
    public void AddMultipleOf_UsesItsOwnCode()
    {
        Assert.Equal(
            ...
            Single(context => context.ReportMultipleOf("quantity", 5m)).Code
        );
    }
    ...
    public void AddAllowedValues_ListsThePermittedSet()
    {
        Assert.Equal(
            ...
            Single(context =>
                context.ReportAllowedValues("status", "available, pending, sold")
            ).Message
        );
    }
