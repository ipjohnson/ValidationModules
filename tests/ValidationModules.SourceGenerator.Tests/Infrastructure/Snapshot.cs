...
namespace ValidationModules.SourceGenerator.Tests.Infrastructure;
...
/// and review the resulting changes under tests/ValidationModules.SourceGenerator.Tests/Snapshots.
///
