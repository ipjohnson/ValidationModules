...
# applied by the analyzer driver, and every descriptor except VM5003 is reported by the generator
# rather than by an analyzer. VM5003 is the only one from ValidateCallAnalyzer. The reference used to
