...
public sealed class ValidateCallAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterCompilationStartAction(static start =>
        {
            ...
            var ruleTargets = new ConcurrentDictionary<INamedTypeSymbol, byte>(
                ...
                operationContext =>
                {
                    ...
                    if (
                        ...
                        || method.ContainingType
                            is not { Name: "ValidationModulesEndpointExtensions" } extensions
                        || extensions.ContainingNamespace?.ToDisplayString()
    ...
    )
    {
        ...
        if (
            target is not INamedTypeSymbol { IsGenericType: false } named
        ...
        context.ReportDiagnostic(
            Diagnostic.Create(
                ValidationDiagnostics.ValidateTargetHasNoValidator,
                location,
                named.Name,
    ...
    private static ITypeSymbol? ElementOf(ITypeSymbol type) =>
        type switch
        {
            ...
            INamedTypeSymbol { IsGenericType: true } named
                when named.ConstructedFrom.ToDisplayString()
