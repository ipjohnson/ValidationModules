...
public static class KnownTypes
{
    ...
    public const string GenerateValidatorAttribute =
        "ValidationModules.Constraints.GenerateValidatorAttribute";
    public const string CustomConstraintAttribute =
        "ValidationModules.Constraints.CustomConstraintAttribute";
    public const string ValidationConstraintAttribute =
        "ValidationModules.Constraints.ValidationConstraintAttribute";
    public const string PerValidationInstanceAttribute =
        "ValidationModules.Constraints.PerValidationInstanceAttribute";
