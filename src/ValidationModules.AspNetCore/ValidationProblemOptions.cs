...
public sealed class ValidationProblemOptions
{
    ...
    {
        if (
            MessageFormatter is not null
            || services.GetService(typeof(ValidationMessageFormatter))
                is not ValidationMessageFormatter formatter
        )
        {
            return this;
        }
    ...
    /// </summary>
    private ValidationProblemOptions Copy() =>
        new()
        {
            Title = Title,
            _type = _type,
