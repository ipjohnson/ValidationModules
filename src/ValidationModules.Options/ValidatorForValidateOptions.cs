    ...
    where TOptions : class
{
    ...
    public ValidatorForValidateOptions(
        string? name,
        IEnumerable<IValidatorFor<TOptions>> validators
    )
    {
        ...
        _name = name;
        _validators =
            validators as IValidatorFor<TOptions>[] ?? System.Linq.Enumerable.ToArray(validators);
    }
